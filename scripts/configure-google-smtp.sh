...
echo "🔧 Google Workspace SMTP Configuration for Supabase"
echo "=================================================="
echo ""
...
echo "  ✓ Google Workspace account with admin access"
echo "  ✓ 2FA enabled on your Google account"
echo "  ✓ Generated Google App Password"
...
echo ""
echo -e "${YELLOW}🌐 Select SMTP Server${NC}"
...
echo -e "${GREEN}✅ Configuration Details Generated!${NC}"
echo ""
echo "=================================================="
echo "📋 NEXT STEPS:"
echo "=================================================="
...
echo -e "${YELLOW}💾 Saving configuration reference...${NC}"
...
echo -e "${GREEN}✅ Configuration saved to: .env.smtp.example${NC}"
echo ""
echo -e "${YELLOW}⚠️  IMPORTANT: Store your app password securely!${NC}"
echo ""
