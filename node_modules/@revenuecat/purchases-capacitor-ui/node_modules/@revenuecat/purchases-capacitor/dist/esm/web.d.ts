...
export declare class PurchasesWeb extends WebPlugin implements PurchasesPlugin {
    ...
    getEligibleWinBackOffersForProduct(_options: GetEligibleWinBackOffersForProductOptions): Promise<{
        eligibleWinBackOffers: PurchasesWinBackOffer[];
    }>;
    getEligibleWinBackOffersForPackage(_options: GetEligibleWinBackOffersForPackageOptions): Promise<{
        eligibleWinBackOffers: PurchasesWinBackOffer[];
    }>;
    purchaseProductWithWinBackOffer(_options: PurchaseProductWithWinBackOfferOptions): Promise<MakePurchaseResult | undefined>;
    purchasePackageWithWinBackOffer(_options: PurchasePackageWithWinBackOfferOptions): Promise<MakePurchaseResult | undefined>;
