...
import { Plus, DollarSign, Calendar, Users, Check, X, Edit, Trash } from 'lucide-react';
...
const ContractorPayments = () => {
  ...
  const [formData, setFormData] = useState<Omit<ContractorPayment, 'id'>>({
    contractor_name: '',
    amount: 0,
  ...
  const getStatusColor = (status: ContractorPayment['status']) => {
    switch (status) {
      case 'completed':
  ...
  const getStatusIcon = (status: ContractorPayment['status']) => {
    switch (status) {
      case 'completed':
  ...
  const getMethodLabel = (method: ContractorPayment['payment_method']) => {
    const labels = {
      cash: 'Cash',
      check: 'Check',
    ...
    <div className="bg-white rounded-lg shadow-md">
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-medium text-gray-900">1099 Contractor Payments</h3>
          {!showAddForm && (
            <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData({...formData, payment_method: e.target.value as ContractorPayment['payment_method']})}
                  required
                  className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData({...formData, status: e.target.value as ContractorPayment['status']})}
                  required
                  className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md"
                >
              ...
              <tr>
                <td colSpan={7} className="px-6 py-12">
                  <div className="text-center">
                    ...
                    <h3 className="mt-2 text-sm font-medium text-gray-900">No contractor payments</h3>
                    <p className="mt-1 text-sm text-gray-500">
                      Get started by adding your first 1099 contractor payment.
                    </p>
                  </div>
                </td>
              </tr>
