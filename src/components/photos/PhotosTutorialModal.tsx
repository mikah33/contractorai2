  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/80 p-4">
      <div className="w-full max-w-sm bg-[#1C1C1E] rounded-2xl overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-[#718189]/30">
          <span className="text-xs text-[#718189] font-semibold">
            ...
            {tutorialSteps.map((_, i) => (
              <div
                ...
                className={`w-2 h-2 rounded-full transition-colors ${
                  i === currentStep ? 'bg-[#718189]' : 'bg-zinc-700'
                }`}
              />
            ))}
          </div>
        ...
        <div className="px-4 pb-6 space-y-4">
          <button
            onClick={handleNext}
            className="w-full py-3.5 bg-[#718189] text-white rounded-xl font-semibold flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
          >
          ...
          <label className="flex items-center justify-center gap-2 text-sm text-zinc-500">
            <input
              ...
              className="rounded border-zinc-600 bg-zinc-800 text-[#718189] focus:ring-blue-500"
            />
