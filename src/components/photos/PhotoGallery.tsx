...
const PhotoGallery: React.FC<PhotoGalleryProps> = ({ projectId, showProjectFilter = false }) => {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        <Loader2 className="w-8 h-8 text-[#718189] animate-spin" />
      </div>
    );
  }
  ...
  if (photos.length === 0) {
    return (
      <div className="text-center py-12 bg-[#1C1C1E] rounded-xl border border-[#718189]/30">
        ...
        <div className="fixed inset-0 z-50 bg-black flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 bg-black/50">
            ...
            <div className="text-center flex-1">
              ...
              {selectedPhoto.projectName && (
                <div className="flex items-center justify-center gap-2 text-[#718189]">
          ...
          {showActionMenu && (
            <div className="absolute top-16 right-4 bg-[#2C2C2E] rounded-xl overflow-hidden shadow-2xl z-10 border border-zinc-700">
              ...
              >
                <Download className="w-5 h-5 text-[#718189]" />
                <span>Download</span>
              </button>
              <button
                onClick={handleShare}
