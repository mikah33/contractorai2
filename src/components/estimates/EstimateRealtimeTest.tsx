  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block w-full max-w-2xl my-8 overflow-hidden text-left align-middle transition-all transform bg-[#1C1C1E] rounded-2xl shadow-xl border border-theme/30">
          {/* Header */}
          <div className="flex items-center justify-between px-6 py-4 border-b border-theme/30">
          ...
          <div className="px-6 py-4 space-y-4">
            <div className="bg-theme/10 border border-theme/30 rounded-lg p-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 p-4 bg-theme text-white rounded-lg font-semibold hover:bg-[#035291] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
